...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  ::-webkit-scrollbar { width: 4px; background: ${C.linen}; }
  ::-webkit-scrollbar-thumb { background: ${C.tan}; border-radius: 2px; }
  input::placeholder { color: ${C.tan}; }
  input:focus { outline: none; border-color: ${C.brown} !important; }
